...
public class DailyServiceImpl extends ServiceImpl<DailyMapper, Daily> implements DailyService {
    ...
    public Map<String, Map<String, Object>> getChartData(String begin, String end) {
        ...
        Map<String, Object> registerNum = this.getChartDataByType(begin, end, "register_num");  // 学员登录数数据
        Map<String, Object> loginNum = this.getChartDataByType(begin, end, "login_num");  // 学员注册数数据
        Map<String, Object> videoViewNum = this.getChartDataByType(begin, end, "video_view_num"); // 课程播放数数据
        Map<String, Object> courseNum = this.getChartDataByType(begin, end, "course_num"); // 每日新增课程数数据
